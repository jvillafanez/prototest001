...
| GetAccount | [GetAccountRequest](#getaccountrequest) | [.ocis.messages.v1.Account](#ocismessagesv1account) | Gets an account rpc GetAccount(GetAccountRequest) returns (Account) { |
| CreateAccount | [CreateAccountRequest](#createaccountrequest) | [.ocis.messages.v1.Account](#ocismessagesv1account) | Creates an account rpc CreateAccount(CreateAccountRequest) returns (Account) { |
| UpdateAccount | [UpdateAccountRequest](#updateaccountrequest) | [.ocis.messages.v1.Account](#ocismessagesv1account) | Updates an account rpc UpdateAccount(UpdateAccountRequest) returns (Account) { |
...
| GetGroup | [GetGroupRequest](#getgrouprequest) | [.ocis.messages.v1.Group](#ocismessagesv1group) | Gets an groups |
| CreateGroup | [CreateGroupRequest](#creategrouprequest) | [.ocis.messages.v1.Group](#ocismessagesv1group) | Creates a group |
| UpdateGroup | [UpdateGroupRequest](#updategrouprequest) | [.ocis.messages.v1.Group](#ocismessagesv1group) | Updates a group |
| DeleteGroup | [DeleteGroupRequest](#deletegrouprequest) | [.google.protobuf.Empty](#googleprotobufempty) | Deletes a group |
| AddMember | [AddMemberRequest](#addmemberrequest) | [.ocis.messages.v1.Group](#ocismessagesv1group) | group:addmember https://docs.microsoft.com/en-us/graph/api/group-post-members?view=graph-rest-1.0&tabs=http |
| RemoveMember | [RemoveMemberRequest](#removememberrequest) | [.ocis.messages.v1.Group](#ocismessagesv1group) | group:removemember https://docs.microsoft.com/en-us/graph/api/group-delete-members?view=graph-rest-1.0 |
